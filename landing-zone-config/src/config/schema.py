"""Schema definition for the landing zone configuration YAML."""

LANDING_ZONE_SCHEMA = {
    "type": "object",
    "required": ["version", "landing_zone", "bootstrap", "org", "environments", "networking", "projects", "app_infra", "org_policies", "fortigate"],
    "properties": {
        "version": {
            "type": "string",
            "pattern": "^\\d+\\.\\d+$"
